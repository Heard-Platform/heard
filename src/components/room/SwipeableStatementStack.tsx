...
interface SwipeableStatementStackProps {
  ...
  coverCardUrl?: string;
  coverCardType?: "youtube" | "image";
  coverCardDescription?: string;
...
export function SwipeableStatementStack({
  ...
  if (coverCardUrl && coverCardType && !coverCardSwiped) {
    const coverCard: CoverCard = { type: "cover", coverType: coverCardType, url: coverCardUrl, description: coverCardDescription };
