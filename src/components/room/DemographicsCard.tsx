...
export function DemographicsCard({
  ...
  return (
    <Card className="w-full h-[400px] bg-gradient-to-br from-purple-100 via-white to-blue-100 border-2 border-purple-300 shadow-xl overflow-hidden">
