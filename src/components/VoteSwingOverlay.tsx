...
import { ThumbsUp, ThumbsDown, RefreshCw, Share, X } from "lucide-react";
  ...
  return createPortal(
    ...
    >
      ...
      >
        ...
        <button
          onClick={onClose}
          className="absolute top-3 right-3 z-20 w-8 h-8 rounded-full bg-white/20 hover:bg-white/30 flex items-center justify-center normal-text transition-colors"
        >
          <X className="w-4 h-4" />
        </button>
        ...
        <div className="relative z-10 flex flex-col items-center text-center gap-4">
          ...
          >
            <p className="text-xs sm:text-sm text-white/90">
              Know anyone else who wants to weigh in?
            </p>
            <div className="flex gap-2">
              <Button onClick={handleShare} disabled={!settled}>
