...
import { MusicLeagueCardStackStory } from "../stories/MusicLeagueCardStack.story";
          ...
          <div className="max-w-6xl mx-auto">
            ...
            >
              <TabsList className="mb-6">
                ...
                <TabsTrigger value="music-league-card-stack">Music League Card Stack</TabsTrigger>
              ...
              <TabsContent value="hide-and-merge-modal">
                <HideAndMergeModalStory />
              </TabsContent>
