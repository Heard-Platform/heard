...
export const styles = {
  ...
  buttonAgree: "display: inline-block; background: #22c55e; color: white; text-decoration: none; padding: 14px 36px; border-radius: 8px; font-weight: bold; font-size: 1.1rem; margin: 8px; box-shadow: 0 4px 12px rgba(34,197,94,0.3);",
  buttonDisagree: "display: inline-block; background: #ef4444; color: white; text-decoration: none; padding: 14px 36px; border-radius: 8px; font-weight: bold; font-size: 1.1rem; margin: 8px; box-shadow: 0 4px 12px rgba(239,68,68,0.3);",
