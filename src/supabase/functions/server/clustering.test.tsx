...
Deno.test("clusterUsers - basic clustering with 4 users and polarized votes", () => {
  ...
  assertEquals(Object.keys(result.metadata.clusterSizes).length, 2);
  assertEquals(
    result.metadata.clusterSizes[0] + result.metadata.clusterSizes[1],
    4,
  );
