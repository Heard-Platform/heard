...
export default function App() {
  ...
  const handleStatementSubmit = useCallback(async (text: string, type?: 'bridge' | 'crux' | 'plurality') => {
  ...
  useEffect(() => {
    ...
    } else if (user && !room && appState !== 'lobby' && appState !== 'room-creation') {
      setAppState('lobby');
          ...
          <div className="flex flex-col sm:flex-row sm:justify-between sm:items-center gap-4">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center gap-4">
              ...
              <div className="flex gap-2">
                <Button onClick={resetToLobby} variant="outline" size="sm">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
            ...
            <div className="lg:col-span-2 space-y-4">
              <h3 className="flex items-center gap-2">
                ...
                {room.phase === 'voting' && <span className="text-sm text-muted-foreground">- Vote now!</span>}
              </h3>
