...
export interface FeatureResults {
  ...
  fundingEvents: {
    ...
    swipeDonate: number;
    swipeDonateUsers: number;
    amountPickerOpened: number;
    amountPickerOpenedUsers: number;
    amountSelected: number;
    amountSelectedUsers: number;
    customAmountConfirmed: number;
    customAmountConfirmedUsers: number;
    checkoutStarted: number;
    checkoutStartedUsers: number;
    checkoutError: number;
    checkoutErrorUsers: number;
    donationSuccess: number;
    donationSuccessUsers: number;
    shareCopy: number;
    shareCopyUsers: number;
    shareNative: number;
    shareNativeUsers: number;
    shareDismissed: number;
    shareDismissedUsers: number;
    goToHeardClicked: number;
    goToHeardClickedUsers: number;
    substackLinkClicked: number;
    substackLinkClickedUsers: number;
    nugmodeToggled: number;
    nugmodeToggledUsers: number;
    exitClicked: number;
    exitClickedUsers: number;
    fallbackDonate: number;
    fallbackDonateUsers: number;
    teaserClicked: number;
    teaserClickedUsers: number;
    teaserDismissed: number;
    teaserDismissedUsers: number;
  };
  fundingEventsSince: number;
  organizersEvents: {
    pageView: number;
    pageViewUsers: number;
    scrolledBelowFold: number;
    scrolledBelowFoldUsers: number;
    ...
    resultsExpanded: number;
    resultsExpandedUsers: number;
    resultsCollapsed: number;
    resultsLoadError: number;
  };
  organizersEventsSince: number;
